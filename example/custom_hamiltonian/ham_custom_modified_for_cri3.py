...
#        h3_c = np.array([[0, 0, 0, -sqrt(3)*self.t3*exp(2*I*pi*(kx + ky))], [0, 0, -sqrt(3)*self.t3*exp(2*I*pi*(kx + ky)), 2*self.t3*exp(2*I*pi*(kx + ky))], [0, -sqrt(3)*self.t3*exp(2*I*pi*(-kx - ky)), 0, 0], [-sqrt(3)*self.t3*exp(2*I*pi*(-kx - ky)), 2*self.t3*exp(2*I*pi*(-kx - ky)), 0, 0]])
        h3_a = np.array([[0, 0, 3*self.t3_a*exp(2*I*pi*(-kx + ky)), 0], [0, 0, 0, -self.t3_b*exp(2*I*pi*(-kx + ky))], [3*self.t3_a*exp(2*I*pi*(kx - ky)), 0, 0, 0], [0, -self.t3_b*exp(2*I*pi*(kx - ky)), 0, 0]])
        h3_b = np.array([[0, 0, (3*self.t3_a/4 - 3*self.t3_b/4)*exp(2*I*pi*(-kx - ky)), (3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)*exp(2*I*pi*(-kx - ky))], [0, 0, (3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)*exp(2*I*pi*(-kx - ky)), (9*self.t3_a/4 - self.t3_b/4)*exp(2*I*pi*(-kx - ky))], [(3*self.t3_a/4 - 3*self.t3_b/4)*exp(2*I*pi*(kx + ky)), (3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)*exp(2*I*pi*(kx + ky)), 0, 0], [(3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)*exp(2*I*pi*(kx + ky)), (9*self.t3_a/4 - self.t3_b/4)*exp(2*I*pi*(kx + ky)), 0, 0]])
        h3_c = np.array([[0, 0, (-3*self.t3_a/8 - 3*self.t3_b/8 + sqrt(3)*(3*sqrt(3)*self.t3_a/4 - sqrt(3)*self.t3_b/4)/2)*exp(2*I*pi*(kx + ky)), (-3*sqrt(3)*self.t3_a/8 + sqrt(3)*self.t3_b/8 - sqrt(3)*(3*self.t3_a/4 + 3*self.t3_b/4)/2)*exp(2*I*pi*(kx + ky))], [0, 0, (3*sqrt(3)*self.t3_a/8 - sqrt(3)*self.t3_b/8 + sqrt(3)*(-9*self.t3_a/4 - self.t3_b/4)/2)*exp(2*I*pi*(kx + ky)), (9*self.t3_a/8 + self.t3_b/8 - sqrt(3)*(-3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)/2)*exp(2*I*pi*(kx + ky))], [(-3*self.t3_a/8 - 3*self.t3_b/8 + sqrt(3)*(3*sqrt(3)*self.t3_a/4 - sqrt(3)*self.t3_b/4)/2)*exp(2*I*pi*(-kx - ky)), (-3*sqrt(3)*self.t3_a/8 + sqrt(3)*self.t3_b/8 - sqrt(3)*(3*self.t3_a/4 + 3*self.t3_b/4)/2)*exp(2*I*pi*(-kx - ky)), 0, 0], [(3*sqrt(3)*self.t3_a/8 - sqrt(3)*self.t3_b/8 + sqrt(3)*(-9*self.t3_a/4 - self.t3_b/4)/2)*exp(2*I*pi*(-kx - ky)), (9*self.t3_a/8 + self.t3_b/8 - sqrt(3)*(-3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)/2)*exp(2*I*pi*(-kx - ky)), 0, 0]])
        #h3_b = np.array([[0, 0, (3*self.t3_a/4 - 3*self.t3_b/4)*exp(2*I*pi*(kx + ky)), (3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)*exp(2*I*pi*(kx + ky))], [0, 0, (3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)*exp(2*I*pi*(kx + ky)), (9*self.t3_a/4 - self.t3_b/4)*exp(2*I*pi*(kx + ky))], [(3*self.t3_a/4 - 3*self.t3_b/4)*exp(2*I*pi*(-kx - ky)), (3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)*exp(2*I*pi*(-kx - ky)), 0, 0], [(3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)*exp(2*I*pi*(-kx - ky)), (9*self.t3_a/4 - self.t3_b/4)*exp(2*I*pi*(-kx - ky)), 0, 0]])
        #h3_c = np.array([[0, 0, (-3*self.t3_a/8 - 3*self.t3_b/8 + sqrt(3)*(3*sqrt(3)*self.t3_a/4 - sqrt(3)*self.t3_b/4)/2)*exp(2*I*pi*(kx + ky)), (-3*sqrt(3)*self.t3_a/8 + sqrt(3)*self.t3_b/8 - sqrt(3)*(3*self.t3_a/4 + 3*self.t3_b/4)/2)*exp(2*I*pi*(kx + ky))], [0, 0, (3*sqrt(3)*self.t3_a/8 - sqrt(3)*self.t3_b/8 + sqrt(3)*(-9*self.t3_a/4 - self.t3_b/4)/2)*exp(2*I*pi*(kx + ky)), (9*self.t3_a/8 + self.t3_b/8 - sqrt(3)*(-3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)/2)*exp(2*I*pi*(kx + ky))], [(-3*self.t3_a/8 - 3*self.t3_b/8 + sqrt(3)*(3*sqrt(3)*self.t3_a/4 - sqrt(3)*self.t3_b/4)/2)*exp(2*I*pi*(-kx - ky)), (-3*sqrt(3)*self.t3_a/8 + sqrt(3)*self.t3_b/8 - sqrt(3)*(3*self.t3_a/4 + 3*self.t3_b/4)/2)*exp(2*I*pi*(-kx - ky)), 0, 0], [(3*sqrt(3)*self.t3_a/8 - sqrt(3)*self.t3_b/8 + sqrt(3)*(-9*self.t3_a/4 - self.t3_b/4)/2)*exp(2*I*pi*(-kx - ky)), (9*self.t3_a/8 + self.t3_b/8 - sqrt(3)*(-3*sqrt(3)*self.t3_a/4 + sqrt(3)*self.t3_b/4)/2)*exp(2*I*pi*(-kx - ky)), 0, 0]])
        h3 = h3_a + h3_b + h3_c
        ...
        m1 = ma + mb + mc
        soc_nn = np.array([[0,0,0,m1],
                           [0,0,-m1,0],
                           [0,np.conjugate(m1),0,0],
                           [-np.conjugate(m1),0,0,0]]) * I * (-1)* self.t1_soc
        m3 = ma3+mb3+mc3
        soc_3nn = np.array([[0,0,0,m3],
                           [0,0,-m3,0],
                           [0,np.conjugate(m3),0,0],
                           [-np.conjugate(m3),0,0,0]]) * I * (-1)* self.t3_soc
